    ...
    <div className="navbar bg-base-100 shadow-sm px-4 lg:px-6">
      ...
      <div className="navbar-start">
        ...
        <Link to="/" className="btn btn-ghost p-0 hover:bg-transparent">
          <span className="text-blue-600 font-bold text-2xl">facebook</span>
        </Link>
      </div>
      ...
      <div className="navbar-center hidden lg:flex gap-1">
        <NavLink
          to="/"
          className={({ isActive }) =>
            `btn btn-ghost btn-sm gap-2 rounded-full ${
      ...
      <div className="navbar-end gap-2">
        <div className="form-control hidden lg:flex">
          <input
            ...
            className="input input-bordered input-sm w-48 rounded-full"
          />
        </div>
