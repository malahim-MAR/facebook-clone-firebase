...
const Navbar = () => {
  return (
    <div
      className="navbar bg-base-100 shadow-lg px-4 md:px-8 fixed top-0 z-50"
      data-theme="dark"
    >
      {/* Mobile Menu */}
      <div className="navbar-start">
      ...
      <div className="navbar-center hidden lg:flex gap-4">
        <div className="flex items-center bg-base-200 rounded-full px-4 py-2 w-64">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex gap-2 ml-4">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `btn btn-ghost btn-circle ${isActive ? "bg-base-300" : ""}`
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
